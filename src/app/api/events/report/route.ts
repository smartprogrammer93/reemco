 ...
 * Returns { window_days, searches, click_outs, click_out_rate,
 * zero_results, zero_result_rate, top_queries } over the requested
 * window (default 7 days, capped at the 90-day raw retention).
 * Also prunes raw events older than 90 days before aggregating.
 */
...
export async function GET(req: NextRequest): Promise<Response> {
  ...
  const report = aggregateWeekly(readEvents(), { windowDays: days });
