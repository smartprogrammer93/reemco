...
export const CATALOG: NormalizedProduct[] = [
  {
    ...
    offers: [
      ...
      },
      {
        ...
        price: 41.2,
        currency: "KWD",
        url: "https://www.bing.com/search?q=Amazon.eg%20(ships%20to%20KW)%20ASUS%20ROG%20Strix%20Scope%20II%2096%20Wireless%20Gaming%20Keyboard",
        inStock: true,
      },
    ],
    coupons: [
    ...
    offers: [
      {
        ...
        price: 33.5,
        currency: "KWD",
        url: "https://www.bing.com/search?q=Amazon.eg%20(ships%20to%20KW)%20Keychron%20V3%20Max%20QMK%20Wireless%20Mechanical%20Keyboard",
        inStock: true,
      },
    ],
    coupons: [],
